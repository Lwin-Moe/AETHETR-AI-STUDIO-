...
from utils.helpers import load_key, save_key, API_KEY_FILE, GROQ_KEY_FILE, OPENAI_KEY_FILE
...
# =====================================================================
# 📌 DYNAMIC PAGE ROUTING (ဖိုင်ခွဲများကို လှမ်းခေါ်ခြင်း)
# =====================================================================
if app_mode == "🎙️ Movie Dubbing Studio":
    # pages folder ထဲမှ movie_dubbing.py ကို လှမ်းခေါ်မည်
    from pages.movie_dubbing import render_movie_dubbing_studio
    render_movie_dubbing_studio(api_key_input, saved_gemini, ai_provider)
    
elif app_mode == "🎙️ Faceless Channel Studio":
    # pages folder ထဲမှ faceless_channel.py ကို လှမ်းခေါ်မည်
